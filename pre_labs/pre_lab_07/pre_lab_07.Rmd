...
```{r echo=FALSE}
census_api_key("5dd119ca55126b9d2a079ba35b3d5e7e60f2c0bb", install=TRUE)
```
...
**Task** Run the following codeblock to calculate the percentage change and put the state with the largest percentage growth below. **Answer: Nevada had the largest percentage change growth.**
...
Is the difference between Calvert and Montgomery significant? **Answer: No, it is not since they overlap.**

Is the difference between Howard and everyone else significant? **Answer: Yes. Howard County doesn't even touch the outlier for any other county.**
...
**Task** Let's look at the average household income for high schools that have 60% or more graduates immediately enrolling in college, and then look at those with less than 40%. Write a sentence describing the results. **Answer:The average income for a high school in Maryland with at least 60% college enrollment is more than $100k while the avg income with at max 40% enrollment is about $70k. **
...
**Task** What is another question you could ask of this data? **Answer: Do the high schools with the lowest median household incomes always have the lowest college enrollment?**
